...
- [Visual Studio Code](https://code.visualstudio.com/) ![VS Code] <img src="[https://cdn.simpleicons.org/leptos/000/fff](https://cdn.jsdelivr.net/npm/simple-icons/icons/visualstudio.svg)" alt="Leptos" align=left width=24 height=24> - A highly customizable code editor with a wide range of extensions for various languages and frameworks.
