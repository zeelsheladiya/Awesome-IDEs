...
| <img src="Resources/Icons/zed.png" alt="icon" width=15 height=15> Zed | a next-generation code editor designed for high-performance collaboration with humans and AI. Works with a few languages such as rust, but more are being added. | [Offical Website](https://zed.dev/) </br> [Github]((https://github.com/zed-industries/zed)) |  `Mac` `Windows (Coming Soon)` `Linux`| Free, Open-Source |
